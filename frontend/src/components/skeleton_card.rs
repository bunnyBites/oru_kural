    ...
    rsx! {
        div {
            ...
            div { class: "flex justify-between mb-3",
                div { class: "animate-shimmer h-3 w-3/4 rounded-full" }
            ...
            div { class: "flex-1 space-y-2 mb-4",
                ...
                div { class: "animate-shimmer h-3 w-full rounded-full" }
                div { class: "animate-shimmer h-3 w-2/3 rounded-full" }
            }
            div { class: "flex items-center gap-2 pt-3 border-t border-tvk-border mt-auto",
                div { class: "animate-shimmer h-5 w-24 rounded-full" }
                div { class: "animate-shimmer h-3 w-12 rounded-full ml-auto" }
            }
        }
    }
}
